...
############################
# Name: Marcel Miron-Celis #
# Student Number: 8298424  #
############################
...
# The mpg dataset has 11 variables and 234 observations
...
ggplot(data=mpg)+geom_point(mapping = aes(x = displ, y = hwy, color=class, shape=drv, size=cyl))+ ggtitle("Highway fuel efficiency according to engine size (displacement in L)")
